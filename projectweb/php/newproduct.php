...
if (isset($_POST['button'])) {
    ...
    if (file_exists($_FILES["fileToUpload"]["tmp_name"]) || is_uploaded_file($_FILES["fileToUpload"]["tmp_name"])) {
        $sqlinsertprod =  "INSERT INTO tbl_product(prname, prtype, prprice, prqty, primage) VALUES('$prname','$prtype','$prprice','$prqty','$picture')";
        try{
...
<body>
    <div class="header">
        ...
        <div class="header-right">
            <a class="active" href="../php/newproduct.php">Home</a>
