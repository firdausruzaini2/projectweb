    ...
    if (isset($_GET['button'])) {
        ...
        if ($op == "Pay") {
            ...
            $data = array(
                ...
                'callback_url' => "https://localhost/webprogramming/projectweb/php/viewproduct.php",
                'redirect_url' => "https://samballana.xifuhalim.com/php/paymentupdate1.php?userid=$email&mobile=$mobile&amount=$amount"
            );
...
<body>
    <div class="header">
        ...
        <div class="header-right">
            <a href="../php/viewproduct.php">Home</a>
